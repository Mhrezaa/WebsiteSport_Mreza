...
<head>
    ...
    <title>Home - sport with Advanture</title>
...
.tagline {
        ...
        <div class="home-wrapper">
            ...
            <div class="kolom">
                    ...
                    <H2 class="deksripsi-h2">Sport shop<br/>
                      ...
                      <p class="deksripsi-h3">Sedia Semua perlengkapan olahraga<br/>
                </div>
            </section>
        </div>
    <
    ...
    <footer>
        <p>&copy; <?php echo date("Y"); ?> Sport Line. Semua hak dilindungi.</p>
    </footer>
</body>
</html>
